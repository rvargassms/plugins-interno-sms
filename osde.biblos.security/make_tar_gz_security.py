...
empaquetarDir( os.path.join( '.', 'conf'), 'conf' )
empaquetarDir( os.path.join( '.', 'gradle'), 'gradle' )
empaquetarDir( os.path.join( '.', 'jsp'), 'jsp' )
empaquetarDir( os.path.join( '.', 'lib'), 'lib' )
empaquetarDir( os.path.join( '.', 'ROOT'), 'ROOT')
empaquetarDir( os.path.join( '.', 'scripts'), 'scripts')
empaquetarDir( os.path.join( '.', 'src'), 'src' )

empaquetarFile( '.', 'build.gradle' )
empaquetarFile( '.', 'build.xml' )
empaquetarFile( '.', 'gradlew' )
empaquetarFile( '.', 'gradlew.bat' )
empaquetarFile( '.', 'MANIFEST.MF' )
empaquetarFile( '.', 'README.md' )
empaquetarFile( '.', 'settings.gradle' )
