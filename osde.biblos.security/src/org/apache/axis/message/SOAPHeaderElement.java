...
//        }
    ...
    public boolean removeAttribute(javax.xml.namespace.QName qname){ return false;}
    public SOAPElement setElementQName(javax.xml.namespace.QName qname){ return null;}
    public QName getElementQName(){return null;}
    public QName createQName(String localName, String prefix){return null;}
    public Iterator getAllAttributesAsQNames(){return null;}
    public String getAttributeValue(QName name){return null;}
    public SOAPElement addAttribute(QName name,String string){return null;}
    public SOAPElement addChildElement(QName name){return null;}
    public Object getUserData(String user){return null;}
    public void setUserData(String a,String b){}
    public Object setUserData(String a,Object b,UserDataHandler c){return null;}
    public Object getFeature(String a,String b){return null;}
    public boolean isEqualNode(Node n){return false;}
    public String lookupNamespaceURI(String a){return null;};
    public boolean isDefaultNamespace(String a){return false;}
    public String lookupPrefix(String a){return null;};
    public boolean isSameNode(Node a){return false;}
    public void setTextContent(String a){};
    public String getTextContent(){return null;};
    public short compareDocumentPosition(Node a){return 0;}
    public String getBaseURI(){return null;};
    public void setIdAttributeNode(Attr a,boolean b){};
    public void setIdAttributeNS(String a,String b,boolean c){};
    public void setIdAttribute(boolean c){};
    public void setIdAttribute(String a,boolean c){};
