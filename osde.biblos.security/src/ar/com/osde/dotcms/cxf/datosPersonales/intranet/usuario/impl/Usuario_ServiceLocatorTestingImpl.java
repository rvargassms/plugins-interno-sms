...
public class Usuario_ServiceLocatorTestingImpl extends Service implements Usuario_ServiceLocator {

    public Usuario_ServiceLocatorTestingImpl() {
    }


    public Usuario_ServiceLocatorTestingImpl(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Usuario_ServiceLocatorTestingImpl(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for UsuarioHttpPort
    private java.lang.String UsuarioHttpPort_address = "http://testesb.osde.ar/services/Usuario/";
