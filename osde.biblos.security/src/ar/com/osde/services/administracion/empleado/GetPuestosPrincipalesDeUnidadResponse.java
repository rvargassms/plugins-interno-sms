/**
 * GetPuestosPrincipalesDeUnidadResponse.java
 *
...
public class GetPuestosPrincipalesDeUnidadResponse  implements java.io.Serializable {
    private ar.com.osde.entities.empleado.PuestoFuncional[] puestosFuncionales;

    public GetPuestosPrincipalesDeUnidadResponse() {
    }
    ...
    /**
     * Gets the puestosFuncionales value for this GetPuestosPrincipalesDeUnidadResponse.
     * 
    ...
    /**
     * Sets the puestosFuncionales value for this GetPuestosPrincipalesDeUnidadResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetPuestosPrincipalesDeUnidadResponse)) return false;
        GetPuestosPrincipalesDeUnidadResponse other = (GetPuestosPrincipalesDeUnidadResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetPuestosPrincipalesDeUnidadResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://osde.com.ar/services/administracion/empleado", "getPuestosPrincipalesDeUnidadResponse"));
