...
public class Empleado_ServiceLocatorProdImpl extends Service implements Empleado_ServiceLocator {
    ...
    private java.lang.String EmpleadoServicePort_address = "http://esb.osde.ar/services/Empleado";

    private java.util.HashSet ports = null;

    
    public Empleado_ServiceLocatorProdImpl() {}
    
    public Empleado_ServiceLocatorProdImpl(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Empleado_ServiceLocatorProdImpl(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
