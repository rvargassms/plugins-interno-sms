/**
 * EmpleadoServiceServiceLocator.java
 *
...
public class EmpleadoServiceServiceLocator extends org.apache.axis.client.Service implements ar.com.osde.services.administracion.empleado.EmpleadoServiceService {

    public EmpleadoServiceServiceLocator() {
    }


    public EmpleadoServiceServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public EmpleadoServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for EmpleadoServicePort
    private java.lang.String EmpleadoServicePort_address = "http://testesb.osde.ar/services/Empleado";
